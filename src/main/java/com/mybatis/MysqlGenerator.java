...
public class MysqlGenerator {
    private static String packageName="D:\\WORKDEV\\sqlclass";    //文件路径
    private static String authorName="administrator";     //作者
    private static String table="t_temperature_alarms_info";                  //table名字
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new DataSourceConfig()
                        ...
                        .setUsername( "root" )
                        .setPassword( "chenyi" )
                        .setUrl( "jdbc:mysql://localhost:3306/spring-boot-demo?useUnicode=true&characterEncoding=utf-8&autoReconnect=true&useSSL=false" )
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
...
//                        .setSuperControllerClass("com.tdx."+packageName+".controller.AbstractController")
                ...
                new PackageConfig()
                        //.setModuleName("User")
                        .setParent("com.kdengine.crpower")// 自定义包路径
